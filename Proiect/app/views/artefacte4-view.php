...
require VIEW_ROOT . '/template/header.php'; ?>
		...
		<h class="first"> ASIAN ARTIFACTS </h>
		</div>
		<?php
			...
			$sql = "SELECT CONCAT(image_path, artefact_name, extension), artefact_name, time_period, geo_position AS image FROM artefacts WHERE id_categorie=4";
